        ...
        $(function () {
            ...
            $("#loginButtonId").click(function () {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "username=" + username + "&password=" + password + "&enCode=" + enCode,
                    success: function (data) {
                        if (data.status) {
                            location.href = "${pageContext.request.contextPath}/back.jsp";
                        } else {
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 249px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
                                       type="test" name="enCode" id="form-code" required placeholder="请输入验证码...">
                            </div>
                            <input type="button" style="width: 380px;border:1px solid #9d9d9d;border-radius: 4px;"
